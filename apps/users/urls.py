...
from apps.users.views import RegisterUserView, UserListView, GithubAuthCallbackView, \
...
urlpatterns = [
    ...
    path('login/github/redirect', GitHubLoginRedirectView.as_view(), name='github_login_redirect'),
